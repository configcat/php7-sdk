...
final class EvaluateLogBuilder
{
    ...
    public static function formatUserComparator(?int $comparator): string
    {
        switch ($comparator) {
            case UserComparator::TEXT_IS_ONE_OF:
            case UserComparator::SENSITIVE_TEXT_IS_ONE_OF:
    ...
    public static function formatPrerequisiteFlagComparator(?int $comparator): string
    {
        switch ($comparator) {
    ...
    public static function formatSegmentComparator(?int $comparator): string
    {
        switch ($comparator) {
    ...
    private function appendUserConditionCore(string $comparisonAttribute, ?int $comparator, ?string $comparisonValue): self
    {
        $comparatorFormatted = self::formatUserComparator($comparator);
        $comparisonValue = $comparisonValue ?? self::INVALID_VALUE_PLACEHOLDER;
